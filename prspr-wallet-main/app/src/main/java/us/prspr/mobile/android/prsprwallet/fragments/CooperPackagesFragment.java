...
public class CooperPackagesFragment extends Fragment {
    private TextView vToolbarTitle;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getContext(), R.layout.fragment_cooper_packages, null);
        // ANDROID-813 vToolbarTitle = (TextView) view.findViewById(R.id.toolbar_title);
        // ANDROID-813 vToolbarTitle.setText(Constants.MIFI_TAB_PACKAGES_TITLE);
        return view;
    }
}
